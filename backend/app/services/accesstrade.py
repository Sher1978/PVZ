...
CAMPAIGN_IDS = {
    "lazada": settings.ACCESSTRADE_LAZADA_CAMPAIGN_ID or "59",      # Lazada VN campaign
    "shopee": settings.ACCESSTRADE_SHOPEE_CAMPAIGN_ID or "59",      # Shopee VN Smartlink
    "kiki":   settings.ACCESSTRADE_KIKI_CAMPAIGN_ID or "",          # Kiki Fashion VN
}
